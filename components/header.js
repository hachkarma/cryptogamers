...
export default function Header() {
  ...
  return (
    <div>
      <nav class="relative px-3 py-3 sm:px-2 sm:px-2 flex justify-between items-center bg-white sm:mb-5">
        <a class="text-3xl font-bold leading-none flex items-center" href="/">
          <Image
            ...
            height='50'
          />
          <span className="text-xl font-bold pl-3">CryptoGamers</span>
        </a>
        <div class="lg:hidden">
